...
export type IndicatorType = 'temperature' | 'co2' | 'ocean' | 'seaIce' | 'seaLevel';
...
export const INDICATOR_METADATA: Record<IndicatorType, IndicatorMeta> = {
  temperature: {
    ...
    subtitle: 'Annual mean land-ocean anomaly vs 1850–1900 baseline',
    unit: '°C anomaly',
    datasetName: 'NASA GISTEMP v4',
    agency: 'NASA Goddard Institute for Space Studies',
    baseline: '1850–1900 Pre-Industrial',
    latestValue: '+1.33°C',
    changeDescription: '+1.4°C warming since pre-industrial era',
  ...
  ocean: {
    id: 'ocean',
    title: 'Ocean Surface Heat & SST Anomaly',
    subtitle: 'Extended reconstructed sea surface temperature anomaly',
    unit: '°C anomaly',
    datasetName: 'NOAA ERSST v5',
    agency: 'NOAA NCEI',
    baseline: '1971–2000 Climatological Mean',
    latestValue: '+0.91°C',
    changeDescription: 'Record ocean heat uptake absorbing 90% of excess planetary heat',
